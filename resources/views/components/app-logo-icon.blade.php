{{--
    The platform mark: a review bubble (RTL, tail on the bottom right) holding
    three score bars that rise with the reading direction.

    Kept in sync with public/favicon.svg, which scripts/brand-icons.mjs renders
    from the same geometry. Change the mark there, not here, then rerun the
    script — tests/Feature/BrandAssetsTest.php asserts the two agree.
--}}
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" role="img" aria-label="تقييم التدريب" {{ $attributes }}>
    <defs>
